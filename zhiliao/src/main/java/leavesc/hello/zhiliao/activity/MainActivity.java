package leavesc.hello.zhiliao.activity;
...
import leavesc.hello.zhiliao.adapter.ArticleThemeListAdapter;
import leavesc.hello.zhiliao.bean.Others;
import leavesc.hello.zhiliao.bean.Theme;
import leavesc.hello.zhiliao.fragment.BaseFragment;
import leavesc.hello.zhiliao.fragment.MainFragment;
import leavesc.hello.zhiliao.fragment.ThemeFragment;
import leavesc.hello.zhiliao.listener.OnLoadThemesListener;
import leavesc.hello.zhiliao.net.HttpUtil;
...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startActivity(new Intent(this, leavesc.hello.zhiliao.activity.StartActivity.class));
